...
This README entry now **covers everything in the room**: email history, protocols, headers, Base64 attachment analysis, and practical commands.  

If you want, I can also **add a small diagram/ASCII workflow of how email travels from sender to recipient** for your GitHub notes—it’ll make your documentation look even more polished. Do you want me to do that?
```
